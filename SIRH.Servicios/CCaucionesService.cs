...
namespace SIRH.Servicios
{
    ...
    public class CCaucionesService : ICCaucionesService
    {
        ...
        {
            return new CCaucionL().AgregarCaucion(funcionario, caucion, aseguradora, montoCaucion);
        ...
        public List<CBaseDTO> ObtenerCaucion(int codigo)
        {
            ...
            return new CCaucionL().ObtenerCaucion(codigo);
        }
        ...
        public List<List<CBaseDTO>> BuscarCauciones(CFuncionarioDTO funcionario, CCaucionDTO caucion,
                                                        ...
                                                        CPuestoDTO puesto, CMontoCaucionDTO nivel)
        {
            CCaucionL respuesta = new CCaucionL();

            return respuesta.BuscarCauciones(funcionario, caucion, fechasEmision, fechasVencimiento, puesto, nivel);
        }
        ...
        {
            return new CPuestoL().ActualizarObservacionesPuestoCaucion(codpuesto, observaciones);
        }
    }
}

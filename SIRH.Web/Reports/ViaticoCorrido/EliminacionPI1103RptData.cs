...
{
    public class EliminacionPI1103RptData
    {
        ...
        internal static EliminacionPI1103RptData GenerarDatosReporte(FormularioViaticoCorridoVM dato, string filtros)
        {
            return new EliminacionPI1103RptData
            {
                ...
                Observacion = dato.MovimientoViaticoCorrido.ObsObservacionesDTO
